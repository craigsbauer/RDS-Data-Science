d3.csv('data_d3.csv',function (data) {
  // CSV section
    ...
    // Tool Tip
      ...
      .append('title') // Tooltip
        .text(function (d) { return d.state +
                             '\npoverty: ' + formatPercent(d['poverty']) +
                             '\nobesity: ' + formatPercent(d['obesity']) +
                             '\nhealthcare: ' + formatPercent(d['healthcare']) })
    // X-axis
    svg.append('g')
        .attr('class','axis')
        .attr('id','xAxis')
